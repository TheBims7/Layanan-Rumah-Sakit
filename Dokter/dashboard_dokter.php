...
<body class="bg-gray-100">
    ...
    <div class="sidebar text-white">
        <div class="overflow-y-auto h-[calc(100vh-64px)]">
            <div class="py-2">
                ...
                <div class="menu-item">
                    <div class="flex items-center justify-between px-4 py-3 text-gray-300 hover:bg-gray-800 cursor-pointer">
    ...
    <main class="content">
        ...
        <div class="profile-box p-6 rounded-lg shadow-sm mb-6">
            <div>
                <h2 class="profil text-2xl font-bold text-black-800 mb-8">Profil Dokter</h2>
