        ...
        <div class="box">
            <div class="form">
                <form action="proses_tambah.php" method="POST">
                    ...
                    <h2>Antrian</h2>
                    <input type="text" name="antrian" required>
                    <h2>Nama Pasien</h2>
                    <input type="text" name="nama" required>
                    <h2>Tanggal Lahir Pasien</h2>
                    <input type="date" name="tanggal_lahir" required>
                    <h2>Jenis Kelamin</h2>
                    <select class="role" name="jenis_kelamin" required>
                        <option value=""></option>
                        <option value="perempuan">Perempuan</option>
                        <option value="laki-laki">Laki-Laki</option>
                    </select>   
                    <h2>Nama Dokter</h2>
                    <select class="role" name="dokter_id" required>
                        <option value=""></option>
                        <?php
                    ...
                    <h2>Poliklinik</h2>
                    <select class="role" name="poli_id" required>
                        <option value=""></option>
                        <?php
