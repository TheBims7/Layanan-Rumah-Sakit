...
<body class="bg-gray-100">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <div class="flex justify-between items-center p-4 border-b">
                    ...
                    <div class="flex space-x-4">
                        <div class="relative">
                            <input type="text" id="akunSearch" placeholder="Cari Akun..." 
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200" id="akunTableBody">
                            <?php
                ...
                <div class="p-4 border-t flex justify-between items-center">
                    <div class="text-sm text-gray-500">
                        Menampilkan <span id="showingFrom">0</span> - <span id="showingTo">0</span> dari <span id="totalakuns">0</span>
                    </div>
    ...
    <script>
        const akuns = <?= $akuns_json ?>;
    </script>
    <script src="Javascript/akun.js"></script>
</body>
</html>